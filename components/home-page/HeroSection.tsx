    ...
    <>
      <section className="grid grid-cols-12 gap-[clamp(1.5rem,3vw,2.5rem)] py-15 bg-pure-white">
        <div className="col-span-7">
          <h1 className="font-display font-bold text-text-primary leading-[1.05] tracking-tight text-7xl">
        ...
        <div className="col-span-5 flex flex-col md:flex-row items-end justify-end gap-4">
          <Link
            href="/audit"
            className="group relative block px-10 py-5 bg-terracotta text-cream font-medium text-center overflow-hidden transition-all duration-500 hover:shadow-lg"
          >
      ...
      <section className="grid grid-cols-12 gap-[clamp(1.5rem,3vw,2.5rem)] py-40 bg-pure-white">
        ...
        <div className="col-span-4 flex items-center px-8">
          <div className="space-y-8">
            <p className="text-text-secondary text-2xl leading-8">
        ...
        <div className="col-span-3 pt-90">
